...
<div class="container">
  ...
  <a class="btn btn-success" href="${pageContext.request.contextPath}/departamentos/nuevo">
            ...
            <tr>
              ...
              <td class="text-center table-actions">
                <a class="btn btn-sm btn-outline-primary"
                   href="${pageContext.request.contextPath}/departamentos/editar?id=${d.idDepartamento}"
                   title="Editar">
                  <i class="bi bi-pencil-square"></i>
                </a>
                <form method="post" action="${pageContext.request.contextPath}/departamentos"
                      onsubmit="return confirm('¿Deseas eliminar este departamento?');">
                  <input type="hidden" name="accion" value="eliminar" />
                  <input type="hidden" name="id" value="${d.idDepartamento}" />
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js"
        integ rity="sha384-YvpcrYf0tY3lHB60NNkmXc5s9fDVZLESaAA55NDzOxhy9GkcIdslK1eN7N6jIeHz"
